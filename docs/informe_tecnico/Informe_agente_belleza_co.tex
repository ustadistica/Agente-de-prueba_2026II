...
recuperación ante salida no parseable y rechazo controlado de un CSV malformado. Estado honesto de la
...
\textbf{Estado:} prototipo funcional versionado (commits \texttt{228c16a} inicial y \texttt{efab75a}
de soporte de despliegue), auditado con revisión de cinco ejes (corrección, legibilidad, arquitectura,
seguridad, rendimiento) con hallazgos corregidos, y con ruta de despliegue documentada.
